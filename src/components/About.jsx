...
export function SectionHeading({ children }) {
  return (
    <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900 mb-10">
      {children}
      <span className="block mt-1.5 w-12 h-1 rounded-full bg-accent-400" />
    </h2>
  )
}
...
export default function About() {
  ...
  const { name, role, interests, bio, photo, links } = profile
        ...
        <div ref={containerRef}>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-12 md:gap-16">
            ...
            <div className="flex-shrink-0">
              <div className="w-48 h-48 md:w-56 md:h-56 rounded-2xl overflow-hidden ring-4 ring-white shadow-xl shadow-slate-200/60">
                {!photoError ? (
                  <img
                    src={photo}
                    alt={name}
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-slate-500 text-sm mb-6">{interests}</p>
